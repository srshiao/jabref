...
public enum KeyBinding {
    ...
    BACK("Back", Localization.lang("Navigate backward in entries"), "ctrl+shift+UP", KeyBindingCategory.VIEW),
    ...
    FORWARD("Forward", Localization.lang("Navigate forward in entries"), "ctrl+shift+DOWN", KeyBindingCategory.VIEW),
